...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo5.gif" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">SmartPhone Store</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">The Failed Team</span></p>
    </div>`);
}
